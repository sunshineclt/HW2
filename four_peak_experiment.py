...
# for i in range(experiment_number):
#     params = fp.generate_params()
#     sa = SimulatedAnnealing(params, neighbor_fp_multi, fp, max_try_per_step=1000, max_iter=1000,
...
for i in range(experiment_number):
    ...
    ga = GeneticAlgorithm(param_group, fp, crossover_pointwise, mutation, max_iter=10000, print_freq=1000, mutation_p=0.1)
...
save_result(result_record, "fp_ga")
