...
# nn_sa = load("nn_sa")
# nn_ga = load("nn_ga")
# plt.plot(range(10, 50001, 10), np.mean(nn_rhc, axis=0)/1200, label="RHC")
# plt.plot(range(10, 50001, 10), np.mean(nn_sa, axis=0)/1200, label="SA")
# plt.plot(range(10, 50001, 10), np.mean(nn_ga, axis=0)/1200, label="GA")
# plt.legend()
# plt.xlabel("iteration")
# plt.ylabel("fitness")
...
nn_sa = load("nn_sa")
nn_sa_9995 = load("nn_sa_9995")
plt.plot(range(10, 50001, 10), np.mean(nn_sa_9995, axis=0)/1200, label="0.9995")
plt.plot(range(10, 50001, 10), np.mean(nn_sa, axis=0)/1200, label="0.997")
plt.legend()
plt.xlabel("iteration")
plt.ylabel("fitness")
plt.savefig("fig/nn_sa_decay_comparison")
plt.show()
